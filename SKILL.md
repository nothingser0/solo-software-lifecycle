...
- [x] **Modul 04: UI/UX Design & Prototyping**: `modules/04-uiux-prototyping.md` — Arsitektur informasi (IA), sitemap & rute, adopsi design system (Shadcn/Tailwind), matriks 5 state antarmuka, dan pembekuan desain (*Design Freeze*).
